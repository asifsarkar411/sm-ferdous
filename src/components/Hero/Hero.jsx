...
const defaultHero = {
  title: 'HELLO THIS IS SM FERDOUS AHMMED',
  subtitle: 'Frontend Developer & IoT Enthusiast',
  description: 'Developing seamless frontend interfaces and robust automation pipelines.',
  imageUrl: null,
  cvUrl: null,
};
        ...
        <div className="animate-float" style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <div style={{ width: '340px', height: '340px', maxWidth: '85vw', maxHeight: '85vw', borderRadius: '50%', overflow: 'hidden', border: '4px solid var(--color-border)', boxShadow: '0 0 35px var(--color-shadow)' }}>
            {hero.imageUrl ? (
              ...
              <div style={{ width: '100%', height: '100%', backgroundColor: 'var(--color-surface)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-text-secondary)' }}>Profile Image</div>
            )}
          </div>
        </div>
      </div>
